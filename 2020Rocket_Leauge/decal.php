           ...
           <h5>
            <table cellspacing="10" frame="void">
              <tr>
                ...
                <td><a href="decal.php" class="currentpage">Decals</a> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
...
#Decal {
  ...
  #Decal:hover #selectColor1  {
    display: block;
    position:relative;
  }
  #Decal:hover #selectCert1  {
    display: block;
    position: relative;
...
<div id="Decal" class ="one">
  <form action="includes/items.inc.php" method="post">
      ...
      <input type="hidden" name="type" value="Decal">
